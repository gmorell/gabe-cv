...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalProjectLink'
        db.create_table(u'projects_externalprojectlink', (
        ...
        db.send_create_signal(u'projects', ['ExternalProjectLink'])


    def backwards(self, orm):
        # Deleting model 'ExternalProjectLink'
        db.delete_table(u'projects_externalprojectlink')
